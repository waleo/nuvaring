...
describe NuvaringCalendar do
	...
	describe "Basic scenario" do
		before do
			...
			@basic_expected_timeline = {"2014-12-27" => "remove", "2015-01-03" => "insert", "2015-01-24" => "remove", "2015-01-31" => "insert", "2015-02-21" => "remove", "2015-02-28" => "insert",
	...
	describe "28 days in, 1 week out, 3 months limit" do
		before do
			...
			@expected_timline = {"2014-12-30" => "remove", "2015-01-06" => "insert", "2015-02-03" => "remove", "2015-02-10" => "insert" }
	...
	describe "1 week in, 2 weeks out, 4 months limit" do
		before do
			...
			@expected_timline = {"2015-05-18" => "remove", "2015-06-01" => "insert", "2015-06-08" => "remove", "2015-06-22" => "insert",
	...
	describe "3 weeks in, swap 3 times, 1 week out" do
		before do
			...
			@expected_insertion_dates = %w[2015-03-02 2015-06-01]
			...
			@expected_timeline = {"2014-12-22" => "swap", "2015-01-12" => "swap", "2015-02-02" => "swap", "2015-02-23" => "remove", "2015-03-02" => "insert",
